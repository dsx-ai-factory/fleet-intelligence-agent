...
After adding the CUDA repository, package dependencies (`datacenter-gpu-manager-4-core`, `datacenter-gpu-manager-4-proprietary`, `nvattest`, and `corelib`) are resolved automatically by `dnf` during Fleet Intelligence Agent installation.
